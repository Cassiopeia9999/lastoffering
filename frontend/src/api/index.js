...
export const apiGetSimilarItems = (id, params) => request.get(`/items/${id}/similar`, { params })
...
export const apiOffShelfItem = (id) => request.post(`/items/${id}/off-shelf`)
...
export const apiAssistantSearch = (data) => request.post('/ai/assistant/search', data, {
  timeout: 90000,
})
export const apiQuickPublishParse = (data) => request.post('/ai/quick-publish/parse', data, {
  timeout: 90000,
})
...
export const apiAdminHardDeleteItem = (id) => request.delete(`/admin/items/${id}/hard`)
...
export const apiAdminGetAiStats = () => request.get('/admin/stats/ai')
